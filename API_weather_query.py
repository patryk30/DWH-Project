...
#df_circuits['circuitId'] = df_circuits['circuitId'].astype(str).astype(int)
#df_circuits['circuitId'] = pd.to_numeric(df_circuits['circuitId'])
...
row1 = pd.DataFrame(data=np.array(Row).reshape(1,33), 
...
row1.to_csv(path_or_buf='C:\\Users\\patry\\OneDrive\\Pulpit\\Zdalne pw\\Hurtownie danych i systemy BI\\Projekt\\idk.csv',
            sep=';')

row1.to_csv(path_or_buf='C:\\Users\\patry\\OneDrive\\Pulpit\\Zdalne pw\\Hurtownie danych i systemy BI\\Projekt\\idk.txt',
            sep=';')
